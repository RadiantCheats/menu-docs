...
2. Run the `/redeem` command by messaging `@RCNeverlose#6322` also make sure you use the same Neverlose username used upon registering on the website.
